...
export default function Search({ searchData }: { searchData: SearchData }) {
    ...
    return (
        ...
        >
            ...
            <div
                onClick={focusInput}
                className="relative flex cursor-text items-center border-0 px-2 shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-green-600 focus-within:ring-inset max-w-sm rounded-md dark:ring-gray-600 dark:text-white dark:bg-gray-800 bg-gray-100 text-gray-900"
            >
                <svg
